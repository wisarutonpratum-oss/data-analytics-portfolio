...
* Focused on business-oriented analytics projects that answer questions such as:
    ...
    * Which products, regions, or campaigns are hurting performance?
...
* Excel — data cleaning, pivot tables, power query, power pivot, reporting, KPI summaries
...
* Marketing / E-commerce Funnel Analysis
...
➡️ Project link: [README.md](https://github.com/wisarutonpratum-oss/financial-performance-analysis/blob/c34aa5efa6ac9d9a7b5e01fccb86e0fa81d785d7/README.md)
...
* BI Analyst
* Reporting Analyst
* Junior Financial / Commercial Analyst (long-term interest)
...
* business thinking
* dashboard reporting
* problem-solving for business performance and customer behavior
